    ...
    <>
        <footer>
            ...
            <aside onMouseLeave={linksBackToNormal}>
                <a href="/" className="footerLinks" onMouseMove={()=>footerLinks(0)} data-cursorpointermini={true}>
                    Home
                </a>
                <a href="/story" className="footerLinks" onMouseMove={()=>footerLinks(1)} data-cursorpointermini={true}>
                    Story
                </a>
                <a href="/media" className="footerLinks" onMouseMove={()=>footerLinks(2)} data-cursorpointermini={true}>
                    Media
                </a>
                <a href="/franchise" className="footerLinks" onMouseMove={()=>footerLinks(3)} data-cursorpointermini={true}>
                    Franchise
                </a>
                <a href="/events" className="footerLinks" onMouseMove={()=>footerLinks(4)} data-cursorpointermini={true}>
                    Events
                </a>
                <a href="/chaiwalacares" className="footerLinks" onMouseMove={()=>footerLinks(5)} data-cursorpointermini={true}>
                    Chai Wala Cares
                </a>
            </aside>
